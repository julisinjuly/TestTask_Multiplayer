...
ATestTask_MultiplayerCharacter::ATestTask_MultiplayerCharacter()
{
...
void ATestTask_MultiplayerCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ATestTask_MultiplayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ATestTask_MultiplayerCharacter::Look);
	}
	else
	{
...
void ATestTask_MultiplayerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATestTask_MultiplayerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
